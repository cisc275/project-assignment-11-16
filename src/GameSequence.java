...
public class GameSequence {
	...
	public GameSequence(int w, int h, boolean mig) {
		...
		elements.add(() -> new GameSequenceElement(new EatingTutorial(w, h, mig), new EatingHUD(w, h, mig)));
		elements.add(() -> new GameSequenceElement(new EatingModel(w, h, mig), new EatingHUD(w, h, mig)));
